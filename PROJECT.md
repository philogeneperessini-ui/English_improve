...
- 对话语音输入、文字兜底、MiniMax 多轮回复与浏览器自动朗读；
...
├── 浏览器 Web Speech API / Android 原生识别：实时转写
├── IndexedDB：录音与历史记录
...
- Android APK 中不包含 MiniMax Key；Git 已忽略 `.env*`、APK、签名文件和 Android 本机配置；
